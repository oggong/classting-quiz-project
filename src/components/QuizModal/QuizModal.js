    ...
    return (
        <div className="absolute md:w-1/3 sm:w-full rounded-lg shadow-lg bg-gray-100 flex flex-col justify-content items-center my-3">
            ...
            <div className="px-5 py-4 flex justify-end">
                <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-24 mx-5 my-5 shadow-md">이전</button>
                <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-24 mx-5 my-5 shadow-md">다음</button>
            </div>
        </div>
    )
}

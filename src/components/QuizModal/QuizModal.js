...
const QuizModal = ({ modalContent, answerCorrect, setMoveNextQuiz }) => {
            ...
            {modalContent ?
                <div className="flex flex-col justify-content items-center">
                    ...
                    <div className="flex my-3">
                        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 w-24 rounded ml-auto" onClick={() => setMoveNextQuiz(true)}>다음 문제</button>
                    </div>
                </div>
                : <div className="flex flex-col justify-content items-center">
